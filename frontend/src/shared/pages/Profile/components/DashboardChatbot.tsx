...
const tokenLabel = (_tokenType: number) => {
    return 'tDUST';
};
...
const formatFallbackSummary = (
    ...
    return [
        ...
        '',
        'Merchant volume:',
        `Main wallet -> tDUST ${merchantStats.mainTDUST}`,
        `Burner wallet -> tDUST ${merchantStats.burnerTDUST}`,
        '',
    ...
    const dashboardContext = useMemo(() => {
        return {
            ...
            stats: {
                ...
                mainVolume: {
                    tdust: merchantStats.mainTDUST,
                },
                burnerVolume: {
                    tdust: merchantStats.burnerTDUST,
                },
            },
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                                                Your intelligent copilot for managing AnonPay merchant data.
                                            </p>
                                        </div>
                                    </div>
