                                    ...
                                    <td className="py-4 px-6 text-center">
                                        {inv.invoiceType === 2 ? (
                                            <div className="flex flex-col items-center gap-1">
                                                {inv.donations?.credits > 0 && <span className="text-xs font-bold text-white">{inv.donations.credits} <span className="text-[10px] text-gray-500 uppercase">tDUST</span></span>}
                                                {inv.donations?.usdcx > 0 && <span className="text-xs font-bold text-white">{inv.donations.usdcx} <span className="text-[10px] text-gray-500 uppercase">tDUST</span></span>}
                                                {inv.donations?.usad > 0 && <span className="text-xs font-bold text-white">{inv.donations.usad} <span className="text-[10px] text-gray-500 uppercase">tDUST</span></span>}
                                                {(!inv.donations || (inv.donations.credits === 0 && inv.donations.usdcx === 0 && inv.donations.usad === 0)) && (
                                                    <span className="font-bold text-gray-500">0 <span className="text-[10px] text-gray-600 uppercase">tDUST</span></span>
                                                )}
                                            </div>
                                        ) : (
