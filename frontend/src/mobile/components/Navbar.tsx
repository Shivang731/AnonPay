        ...
        >
            <div className="w-full max-w-7xl flex items-center justify-between pointer-events-auto">
                ...
                <div className="transform scale-90 origin-right">
                    <WalletConnectButton className="bg-black/50 backdrop-blur-lg border border-white/10 rounded-full py-2 px-4 h-auto font-sans font-semibold text-xs text-white hover:bg-white/10 hover:border-white/30 transition-all" />
                </div>
            </div>
