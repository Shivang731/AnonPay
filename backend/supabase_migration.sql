...
-- ==========================================
-- MIGRATION: SELECTIVE DISCLOSURE PROOFS
-- ==========================================
...
CREATE INDEX IF NOT EXISTS idx_disclosures_proof_id ON disclosures(proof_id);
CREATE INDEX IF NOT EXISTS idx_disclosures_invoice_id ON disclosures(invoice_id);
