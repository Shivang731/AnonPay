...
export type Witnesses<PS> = {
  ...
  payerNonce(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
}
...
export type ImpureCircuits<PS> = {
  ...
  pay_invoice(context: __compactRuntime.CircuitContext<PS>, invoice_id_0: bigint): __compactRuntime.CircuitResults<PS, []>;
